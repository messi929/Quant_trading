...
| 시각 | 작업 |
|------|------|
| 06:10 | US 신호 생성 (NASDAQ 전일 종가, 캐시 무시) + 하락 종목 매도 |
| 23:40 | US Wave 1 (40%, 해외 종목) — 06:10 신호 그대로 집행 |
...
**일간 자동 스케줄 (KST) — Phase 11 확정**:

| 시각 | 작업 |
|------|------|
| 06:00 | 데이터 수집 (KR + US 전일 종가) |
| 06:10 | [US] NASDAQ 종가 신호 생성 + 하락 종목 매도 |
| 06:30 | [KR] 신호 생성 + 하락 종목 매도 |
| 09:10 | [KR] Wave 1 (40%, 국내 종목) |
| 11:00 | [KR] Wave 2 (35%, 국내 종목) |
| 13:30 | [KR] Wave 3 (25%, 국내 종목) |
| 16:00 | 종가 기록 + 성과 업데이트 |
| 23:40 | [US] Wave 1 (40%, 해외 종목) ← 06:10 신호 집행 |
| 02:00 | [US] Wave 2 (35%, 해외 종목) |
| 04:30 | [US] Wave 3 (25%, 해외 종목) |

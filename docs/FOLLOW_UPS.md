...
[완료]   06-19      제안 #3 동적 슬리피지(`korea_slippage.py`) — square-root impact
                     (base0.2%+2k·σ·√(Q/ADV), k=1). 결론: ① 1억 규모 동적 0.396%≈고정
                     0.4% 무차이 → 라이브 변경 불필요. ② 크래시 비용 팽창 가설 반증(평시
                     1.59% vs 크래시 1.55% ×0.97 — 한국 크래시=거래대금 폭증+게이트 OFF로
                     비싼 거래 회피, 게이트 방어 과대평가 아님). ③ 진짜 발견=capacity 한계
                     (Sharpe 1억0.66/10억0.55/50억0.36, 슬리피지 잠식). ④ 유동성 floor 공식
                     ADV_floor=(자본/20)/(0.3%/kσ)² → 1억:3억/10억:27억/50억:136억.
